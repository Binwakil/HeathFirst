...
/**
 * Created by almustapha on 10/6/18.
 */
...
public class CommentListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    List<CommentlistDataItem> data= Collections.emptyList();
    int currentPos=0;
    ...
    public CommentListAdapter(Context context, Activity activity, List<CommentlistDataItem> data){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.commentlist, parent,false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        final CommentlistDataItem current=data.get(position);
        myHolder.username.setText(current.Username);
        myHolder.msg.setText(current.Comment);
